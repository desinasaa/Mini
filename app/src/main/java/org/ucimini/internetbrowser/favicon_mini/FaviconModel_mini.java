package org.ucimini.internetbrowser.favicon_mini;
 ...
 */
@Singleton
public class FaviconModel_mini {

    private static final String TAG = "FaviconModel_mini";
    ...
    @Inject
    FaviconModel_mini(@NonNull Application application) {
    ...
    public static File getFaviconCacheFile(@NonNull Application app, @NonNull Uri uri) {
        FaviconUtils_mini.assertUriSafe(uri);
    ...
    public Single<Bitmap> faviconForUrl(@NonNull final String url,
        ...
        return Single.create(new SingleAction<Bitmap>() {
            ...
            public void onSubscribe(@NonNull SingleSubscriber<Bitmap> subscriber) {
                Uri uri = FaviconUtils_mini.safeUri(url);
