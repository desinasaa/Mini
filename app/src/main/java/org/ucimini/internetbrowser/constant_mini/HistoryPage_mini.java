...
public class HistoryPage_mini {

    private static final String TAG = "HistoryPage_mini";
                ...
                mHistoryModel.lastHundredVisitedHistoryItems()
                    .subscribe(new SingleOnSubscribe<List<HistoryItem_mini>>() {
                        ...
                        public void onItem(@Nullable List<HistoryItem_mini> item) {
                            ...
                            Iterator<HistoryItem_mini> it = item.iterator();
                            HistoryItem_mini helper;
                            while (it.hasNext()) {
                                helper = it.next();
                            ...
                            subscriber.onItem(Constants_mini.FILE + historyWebPage);
