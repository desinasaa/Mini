...
public final class Constants_mini {

    private Constants_mini() {
    }
    ...
    public static final String SCHEME_HOMEPAGE = Constants_mini.ABOUT + "home";
    public static final String SCHEME_BLANK = Constants_mini.ABOUT + "blank";
    public static final String SCHEME_BOOKMARKS = Constants_mini.ABOUT + "bookmarks";
