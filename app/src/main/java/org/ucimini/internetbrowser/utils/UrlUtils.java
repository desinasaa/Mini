...
public class UrlUtils {
    ...
    public static boolean isSpecialUrl(@Nullable String url) {
        return url != null && url.startsWith(Constants_mini.FILE) &&
            (url.endsWith(BookmarkPage_mini.FILENAME) ||
                url.endsWith(DownloadsPage_mini.FILENAME) ||
                url.endsWith(HistoryPage_mini.FILENAME) ||
                url.endsWith(StartPage_mini.FILENAME));
    }
    ...
    public static boolean isBookmarkUrl(@Nullable String url) {
        return url != null && url.startsWith(Constants_mini.FILE) && url.endsWith(BookmarkPage_mini.FILENAME);
    }
    ...
    public static boolean isDownloadsUrl(@Nullable String url) {
        return url != null && url.startsWith(Constants_mini.FILE) && url.endsWith(DownloadsPage_mini.FILENAME);
    }
    ...
    public static boolean isHistoryUrl(@Nullable String url) {
        return url != null && url.startsWith(Constants_mini.FILE) && url.endsWith(HistoryPage_mini.FILENAME);
    }
    ...
    public static boolean isStartPageUrl(@Nullable String url) {
        return url != null && url.startsWith(Constants_mini.FILE) && url.endsWith(StartPage_mini.FILENAME);
    }
}