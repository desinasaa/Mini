...
public abstract class BaseSuggestionsModel {
    ...
    /**
     * Parse the results of an input stream into a list of {@link HistoryItem_mini}.
     *
     ...
     */
    protected abstract void parseResults(@NonNull InputStream inputStream, @NonNull List<HistoryItem_mini> results) throws Exception;
     ...
     */
    @NonNull
    public final List<HistoryItem_mini> fetchResults(@NonNull final String rawQuery) {
        List<HistoryItem_mini> filter = new ArrayList<>(5);
