 ...
 * Web Address Parser
 * <p/>
 * This is called WebAddress_mini, rather than URL or URI, because it attempts to
...
class WebAddress_mini {
     ...
     */
    public WebAddress_mini(@Nullable String address) throws IllegalArgumentException {
