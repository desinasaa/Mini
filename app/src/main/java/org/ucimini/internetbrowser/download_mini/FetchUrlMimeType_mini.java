 ...
 */
class FetchUrlMimeType_mini extends Thread {

    private static final String TAG = "FetchUrlMimeType_mini";
    ...
    public FetchUrlMimeType_mini(Activity context, DownloadManager.Request request, String uri,
