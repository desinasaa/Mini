 ...
 */
package org.ucimini.internetbrowser.download_mini;
...
import org.ucimini.internetbrowser.MainActivity;
...
import org.ucimini.internetbrowser.database_mini.downloads.DownloadItem;
 ...
 */
public class DownloadHandler_mini {

    private static final String TAG = "DownloadHandler_mini";

    private static final String COOKIE_REQUEST_HEADER = "Cookie";

    @Inject DownloadsModel downloadsModel;

    public DownloadHandler_mini() {
     ...
     */
    public void onDownloadStart(@NonNull Activity context, @NonNull PreferenceManager_mini manager, String url, String userAgent,
     ...
     */
    /* package */
    private void onDownloadStartNoStream(@NonNull final Activity context, @NonNull PreferenceManager_mini preferences,
        ...
        WebAddress_mini WebAddress_mini;
        try {
            WebAddress_mini = new WebAddress_mini(url);
            WebAddress_mini.setPath(encodePath(WebAddress_mini.getPath()));
        } catch (Exception e) {
        ...
        String addressString = WebAddress_mini.toString();
        ...
        request.setDestinationUri(Uri.parse(Constants_mini.FILE + location + filename));
        // let this downloaded file be scanned by MediaScanner - so that it can
        // show up in Gallery app, for example.
        request.setVisibleInDownloadsUi(true);
        request.allowScanningByMediaScanner();
        request.setDescription(WebAddress_mini.getHost());
        ...
        if (mimetype == null) {
            ...
            new FetchUrlMimeType_mini(context, request, addressString, cookies, userAgent).start();
        } else {
        ...
        UIController_mini browserActivity = (UIController_mini) context;
