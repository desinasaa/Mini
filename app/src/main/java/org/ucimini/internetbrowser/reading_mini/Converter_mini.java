 ...
 * @author Peter Karich
 */
public class Converter_mini {

    private static final String TAG = "Converter_mini";
    ...
    public Converter_mini(String urlOnlyHint) {
        url = urlOnlyHint;
    }

    public Converter_mini() {
    }

    public Converter_mini setMaxBytes(int maxBytes) {
