...
public class HtmlFetcher {
    ...
    private ArticleTextExtractor_mini extractor = new ArticleTextExtractor_mini();
    ...
    public void setExtractor(ArticleTextExtractor_mini extractor) {
        this.extractor = extractor;
    }

    public ArticleTextExtractor_mini getExtractor() {
        return extractor;
    }
    ...
    private String fetchAsString(String urlAsString, int timeout, boolean includeSomeGooseOptions)
        ...
        String enc = Converter_mini.extractEncoding(hConn.getContentType());
        return createConverter(urlAsString).streamToString(is, enc);
    }

    private static Converter_mini createConverter(String url) {
        return new Converter_mini(url);
    }
