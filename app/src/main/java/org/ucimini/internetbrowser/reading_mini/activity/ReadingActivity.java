package org.ucimini.internetbrowser.reading_mini.activity;
...
import org.ucimini.internetbrowser.reading_mini.HtmlFetcher;
import org.ucimini.internetbrowser.reading_mini.JResult;
...
public class ReadingActivity extends AppCompatActivity {
    ...
    private boolean loadPage(Intent intent) {
        ...
        mUrl = intent.getStringExtra(Constants_mini.LOAD_READING_URL);
        if (mUrl == null) {
            return false;
        }
        if (getSupportActionBar() != null)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.invert_item:
                ...
                read.putExtra(Constants_mini.LOAD_READING_URL, mUrl);
                startActivity(read);
                finish();
                break;
