...
import org.ucimini.internetbrowser.database_mini.bookmark.BookmarkExporter;
import org.ucimini.internetbrowser.database_mini.bookmark.BookmarkLocalSync;
import org.ucimini.internetbrowser.database_mini.bookmark.BookmarkLocalSync.Source;
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (mFileList[which].isDirectory()) {
                    ...
                    mImportSubscription = BookmarkExporter.importBookmarksFromFile(mFileList[which])
                        ...
                        .subscribe(new SingleOnSubscribe<List<HistoryItem_mini>>() {
                            @Override
                            public void onItem(@Nullable final List<HistoryItem_mini> importList) {
