...
public class PrivacySettingsFragment extends LightningPreferenceFragment implements Preference.OnPreferenceClickListener, Preference.OnPreferenceChangeListener {
    ...
    private void initPrefs() {
        ...
        cblocation.setChecked(mPreferenceManagerMini.getLocationEnabled());
        cbsavepasswords.setChecked(mPreferenceManagerMini.getSavePasswordsEnabled());
        cbcacheexit.setChecked(mPreferenceManagerMini.getClearCacheExit());
        cbhistoryexit.setChecked(mPreferenceManagerMini.getClearHistoryExitEnabled());
        cbcookiesexit.setChecked(mPreferenceManagerMini.getClearCookiesExitEnabled());
        cb3cookies.setChecked(mPreferenceManagerMini.getBlockThirdPartyCookiesEnabled());
        cbwebstorageexit.setChecked(mPreferenceManagerMini.getClearWebStorageExitEnabled());
        cbDoNotTrack.setChecked(mPreferenceManagerMini.getDoNotTrackEnabled() && Utils.doesSupportHeaders());
        cbIdentifyingHeaders.setChecked(mPreferenceManagerMini.getRemoveIdentifyingHeadersEnabled() && Utils.doesSupportHeaders());
    ...
    public boolean onPreferenceChange(@NonNull Preference preference, Object newValue) {
        switch (preference.getKey()) {
            case SETTINGS_LOCATION:
                mPreferenceManagerMini.setLocationEnabled((Boolean) newValue);
                return true;
            case SETTINGS_THIRDPCOOKIES:
                mPreferenceManagerMini.setBlockThirdPartyCookiesEnabled((Boolean) newValue);
                return true;
            case SETTINGS_SAVEPASSWORD:
                mPreferenceManagerMini.setSavePasswordsEnabled((Boolean) newValue);
                return true;
            case SETTINGS_CACHEEXIT:
                mPreferenceManagerMini.setClearCacheExit((Boolean) newValue);
                return true;
            case SETTINGS_HISTORYEXIT:
                mPreferenceManagerMini.setClearHistoryExitEnabled((Boolean) newValue);
                return true;
            case SETTINGS_COOKIEEXIT:
                mPreferenceManagerMini.setClearCookiesExitEnabled((Boolean) newValue);
                return true;
            case SETTINGS_WEBSTORAGEEXIT:
                mPreferenceManagerMini.setClearWebStorageExitEnabled((Boolean) newValue);
                return true;
            case SETTINGS_DONOTTRACK:
                mPreferenceManagerMini.setDoNotTrackEnabled((Boolean) newValue);
                return true;
            case SETTINGS_IDENTIFYINGHEADERS:
                mPreferenceManagerMini.setRemoveIdentifyingHeadersEnabled((Boolean) newValue);
                return true;
            default:
                return false;
        }
