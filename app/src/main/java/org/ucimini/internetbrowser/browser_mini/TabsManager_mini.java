 ...
 */
public class TabsManager_mini {

    private static final String TAG = "TabsManager_mini";
    ...
    public synchronized Completable initializeTabs(@NonNull final Activity activity,
        ...
        return Completable.create(new CompletableAction() {
            ...
            public void onSubscribe(@NonNull CompletableSubscriber subscriber) {
                ...
                mCurrentTab = null;
                if (mPreferenceManagerMini.getRestoreLostTabsEnabled()) {
                ...
                public void onNext(@Nullable Bundle item) {
                    ...
                    if (url != null && tab.getWebView() != null) {
                        if (UrlUtils.isBookmarkUrl(url)) {
                            new BookmarkPage_mini(activity).getBookmarkPage()
                                .subscribeOn(Schedulers.io())
                                .observeOn(Schedulers.main())
