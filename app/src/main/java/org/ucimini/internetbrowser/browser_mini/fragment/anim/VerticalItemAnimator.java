 ...
 */
package org.ucimini.internetbrowser.browser_mini.fragment.anim;
...
public class VerticalItemAnimator extends SimpleItemAnimator {
    ...
    private void animateAddImpl(final ViewHolder holder) {
        ...
        animation.alpha(1).translationX(0).setDuration(getAddDuration())
                .setInterpolator(new BezierDecelerateInterpolator_mini()).setListener(new VpaListenerAdapter() {
                    @Override
                    public void onAnimationStart(View view) {
