...
import org.ucimini.internetbrowser.browser_mini.fragment.anim.HorizontalItemAnimator;
import org.ucimini.internetbrowser.browser_mini.fragment.anim.VerticalItemAnimator;
...
import org.ucimini.internetbrowser.view_mini.BackgroundDrawable;
 ...
 */
public class TabsFragment_miniMini extends Fragment implements View.OnClickListener, View.OnLongClickListener, TabsView_mini {

    @NonNull
    public static TabsFragment_miniMini createTabsFragment(boolean isIncognito, boolean showTabsInDrawer) {
        TabsFragment_miniMini tabsFragment = new TabsFragment_miniMini();
        final Bundle tabsFragmentArguments = new Bundle();
        tabsFragmentArguments.putBoolean(TabsFragment_miniMini.IS_INCOGNITO, isIncognito);
        tabsFragmentArguments.putBoolean(TabsFragment_miniMini.VERTICAL_MODE, showTabsInDrawer);
        tabsFragment.setArguments(tabsFragmentArguments);

        return tabsFragment;
    }

    private static final String TAG = "TabsFragment_miniMini";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mUiControllerMini = (UIController_mini) getActivity();
        ...
        if (mShowInNavigationDrawer) {
            ...
            newTab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mUiControllerMini.newTabButtonClicked();
                }
            });
        }
    ...
    public void onClick(@NonNull View v) {
        switch (v.getId()) {
            case R.id.tab_header_button:
                mUiControllerMini.showCloseDialog(getTabsManager().indexOfCurrentTab());
                break;
            case R.id.new_tab_button:
                mUiControllerMini.newTabButtonClicked();
                break;
            case R.id.action_back:
                mUiControllerMini.onBackButtonPressed();
                break;
            case R.id.action_forward:
                mUiControllerMini.onForwardButtonPressed();
                break;
            case R.id.action_home:
                mUiControllerMini.onHomeButtonPressed();
            default:
                break;
        }
    }
    ...
    public boolean onLongClick(@NonNull View v) {
        switch (v.getId()) {
            case R.id.action_new_tab:
                mUiControllerMini.newTabButtonLongClicked();
                break;
            default:
                break;
        }
    ...
    private class LightningViewAdapter extends RecyclerView.Adapter<LightningViewAdapter.LightningViewHolder> {
            ...
            if (web.isForegroundTab()) {
                ...
                if (!mDrawerTabs) {
                    ...
                    if (!mIsIncognito && mColorMode) {
                        foregroundDrawable.setColorFilter(mUiControllerMini.getUiColor(), PorterDuff.Mode.SRC_IN);
                    }
                }
                if (!mIsIncognito && mColorMode) {
                    mUiControllerMini.changeToolbarBackground(favicon, foregroundDrawable);
                }
        ...
        public class LightningViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
            ...
            public void onClick(View v) {
                if (v == exitButton) {
                    mUiControllerMini.tabCloseClicked(getAdapterPosition());
                }
                if (v == layout) {
                    mUiControllerMini.tabClicked(getAdapterPosition());
                }
            }

            @Override
            public boolean onLongClick(View v) {
                mUiControllerMini.showCloseDialog(getAdapterPosition());
                return true;
            }
        }
    }
