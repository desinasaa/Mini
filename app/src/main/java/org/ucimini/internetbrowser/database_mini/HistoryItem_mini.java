 ...
 */
package org.ucimini.internetbrowser.database_mini;
...
public class HistoryItem_mini implements Comparable<HistoryItem_mini> {
    ...
    public HistoryItem_mini() {}

    public HistoryItem_mini(@NonNull String url, @NonNull String title) {
    ...
    public HistoryItem_mini(@NonNull String url, @NonNull String title, int imageId) {
        Preconditions.checkNonNull(url);
        Preconditions.checkNonNull(title);
        this.mUrl = url;
        this.mTitle = title;
    ...
    @Override
    public int compareTo(@NonNull HistoryItem_mini another) {
    ...
    public boolean equals(Object o) {
        ...
        HistoryItem_mini that = (HistoryItem_mini) o;
