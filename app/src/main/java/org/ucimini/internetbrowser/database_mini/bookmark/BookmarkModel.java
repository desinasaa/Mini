...
public interface BookmarkModel {
     ...
     */
    @NonNull
    Single<HistoryItem_mini> findBookmarkForUrl(@NonNull String url);
     ...
     */
    @NonNull
    Single<Boolean> addBookmarkIfNotExists(@NonNull HistoryItem_mini item);
     ...
     */
    @NonNull
    Completable addBookmarkList(@NonNull List<HistoryItem_mini> bookmarkItems);
     ...
     */
    @NonNull
    Single<Boolean> deleteBookmark(@NonNull HistoryItem_mini bookmark);
     ...
     */
    @NonNull
    Completable editBookmark(@NonNull HistoryItem_mini oldBookmark, @NonNull HistoryItem_mini newBookmark);
     ...
     */
    @NonNull
    Single<List<HistoryItem_mini>> getBookmarksFromFolderSorted(@Nullable String folder);

    /**
     * Returns all folders as {@link HistoryItem_mini}.
