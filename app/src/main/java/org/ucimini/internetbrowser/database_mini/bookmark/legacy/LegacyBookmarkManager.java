package org.ucimini.internetbrowser.database_mini.bookmark.legacy;
...
public class LegacyBookmarkManager {
    ...
    @WorkerThread
    @NonNull
    public static List<HistoryItem_mini> destructiveGetBookmarks(@NonNull Application application) {
     ...
     */
    private static class SortIgnoreCase implements Comparator<HistoryItem_mini> {

        public int compare(@Nullable HistoryItem_mini o1, @Nullable HistoryItem_mini o2) {
            if (o1 == null || o2 == null) {
                return 0;
            }
