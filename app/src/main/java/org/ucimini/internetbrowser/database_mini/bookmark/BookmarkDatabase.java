package org.ucimini.internetbrowser.database_mini.bookmark;
...
public class BookmarkDatabase extends SQLiteOpenHelper implements BookmarkModel {
    ...
    /**
     * Binds a {@link HistoryItem_mini} to {@link ContentValues}.
     *
     ...
     */
    @NonNull
    private static ContentValues bindBookmarkToContentValues(@NonNull HistoryItem_mini bookmarkItem) {
    ...
    /**
     * Binds a cursor to a {@link HistoryItem_mini}. This is
     ...
     */
    @NonNull
    private static HistoryItem_mini bindCursorToHistoryItem(@NonNull Cursor cursor) {
        HistoryItem_mini bookmark = new HistoryItem_mini();
    ...
    /**
     * Binds a cursor to a list of {@link HistoryItem_mini}.
     ...
     */
    @NonNull
    private static List<HistoryItem_mini> bindCursorToHistoryItemList(@NonNull Cursor cursor) {
        List<HistoryItem_mini> bookmarks = new ArrayList<>();
    ...
    @NonNull
    @Override
    public Single<HistoryItem_mini> findBookmarkForUrl(@NonNull final String url) {
        return Single.create(new SingleAction<HistoryItem_mini>() {
            @Override
            public void onSubscribe(@NonNull SingleSubscriber<HistoryItem_mini> subscriber) {
    ...
    @NonNull
    @Override
    public Single<Boolean> addBookmarkIfNotExists(@NonNull final HistoryItem_mini item) {
        return Single.create(new SingleAction<Boolean>() {
            @Override
            public void onSubscribe(@NonNull SingleSubscriber<Boolean> subscriber) {
    ...
    @NonNull
    @Override
    public Completable addBookmarkList(@NonNull final List<HistoryItem_mini> bookmarkItems) {
        return Completable.create(new CompletableAction() {
            @Override
            public void onSubscribe(@NonNull CompletableSubscriber subscriber) {
                lazyDatabase().beginTransaction();

                for (HistoryItem_mini item : bookmarkItems) {
    ...
    @NonNull
    @Override
    public Single<Boolean> deleteBookmark(@NonNull final HistoryItem_mini bookmark) {
        return Single.create(new SingleAction<Boolean>() {
            @Override
            public void onSubscribe(@NonNull SingleSubscriber<Boolean> subscriber) {
    ...
    @NonNull
    @Override
    public Completable editBookmark(@NonNull final HistoryItem_mini oldBookmark, @NonNull final HistoryItem_mini newBookmark) {
        return Completable.create(new CompletableAction() {
            @Override
            public void onSubscribe(@NonNull CompletableSubscriber subscriber) {
    ...
    @NonNull
    @Override
    public Single<List<HistoryItem_mini>> getBookmarksFromFolderSorted(@Nullable final String folder) {
        return Single.create(new SingleAction<List<HistoryItem_mini>>() {
            @Override
            public void onSubscribe(@NonNull SingleSubscriber<List<HistoryItem_mini>> subscriber) {
                ...
                List<HistoryItem_mini> list = bindCursorToHistoryItemList(cursor);
    ...
    public Single<List<HistoryItem_mini>> getFoldersSorted() {
        return Single.create(new SingleAction<List<HistoryItem_mini>>() {
            ...
            public void onSubscribe(@NonNull SingleSubscriber<List<HistoryItem_mini>> subscriber) {
                ...
                List<HistoryItem_mini> folders = new ArrayList<>();
                while (cursor.moveToNext()) {
                    ...
                    final HistoryItem_mini folder = new HistoryItem_mini();
                    folder.setIsFolder(true);
                    folder.setTitle(folderName);
                    folder.setImageId(R.drawable.ic_folder);
                    folder.setUrl(Constants_mini.FOLDER + folderName);
