...
public class BookmarkExporter {
        ...
        try {
            ...
            while ((line = bookmarksReader.readLine()) != null) {
                try {
                    ...
                    HistoryItem_mini item = new HistoryItem_mini();
     ...
     */
    @NonNull
    public static Completable exportBookmarksToFile(@NonNull final List<HistoryItem_mini> bookmarkList,
        ...
        return Completable.create(new CompletableAction() {
            ...
            public void onSubscribe(@NonNull final CompletableSubscriber subscriber) {
                ...
                try {
                    ...
                    for (HistoryItem_mini item : bookmarkList) {
