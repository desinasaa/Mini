package org.ucimini.internetbrowser.preference_mini;
...
@Singleton
public class PreferenceManager_mini {

    private static class Name {
        static final String ADOBE_FLASH_SUPPORT = "enableflash";
        static final String BLOCK_ADS = "AdBlock_mini";
    ...
    @Inject
    PreferenceManager_mini(@NonNull final Context context) {
    ...
    public String getHomepage() {
        return mPrefs.getString(Name.HOMEPAGE, Constants_mini.SCHEME_HOMEPAGE);
    }
    ...
    public String getSearchUrl() {
        return mPrefs.getString(Name.SEARCH_URL, Constants_mini.GOOGLE_SEARCH);
    }
    ...
    public int getProxyChoice() {
        @Constants_mini.Proxy int proxy = mPrefs.getInt(Name.PROXY_CHOICE, Constants_mini.NO_PROXY);
        switch (proxy) {
            ...
            case Constants_mini.PROXY_MANUAL:
                return proxy;
            default:
                return Constants_mini.NO_PROXY;
        }
    }
    ...
    public String getTextEncoding() {
        return mPrefs.getString(Name.TEXT_ENCODING, Constants_mini.DEFAULT_ENCODING);
    }
     ...
     * Valid choices:
     * <ul>
     * <li>{@link Constants_mini#NO_PROXY}</li>
     * <li>{@link Constants_mini#PROXY_ORBOT}</li>
     * <li>{@link Constants_mini#PROXY_I2P}</li>
     * </ul>
     *
     * @param choice the proxy to use.
     */
    public void setProxyChoice(@Constants_mini.Proxy int choice) {
        putBoolean(Name.USE_PROXY, choice != Constants_mini.NO_PROXY);
